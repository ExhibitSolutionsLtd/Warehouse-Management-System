"""
Django settings for Warehouse_MS project.
...
SECRET_KEY = 'django-insecure-pa4!wt-k1a#2mvvk(=segq-&j++4(v422*k*idvr+2^#+sg-=d'
...
ROOT_URLCONF = 'Warehouse_MS.urls'
...
WSGI_APPLICATION = 'Warehouse_MS.wsgi.application'
